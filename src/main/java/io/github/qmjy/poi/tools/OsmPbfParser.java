 ...
 */
package io.github.qmjy.poi.tools;

import crosby.binary.osmosis.OsmosisReader;
import io.github.qmjy.poi.osm.*;
import io.github.qmjy.poi.utils.*;
...
public class OsmPbfParser implements Sink {
    ...
    MathTransform reproject;
    int sourceSRID;                       //Source CRS according to EPSG
    int targetSRID;                       //Target CRS according to EPSG
    private final Configuration currentConfig;  //User-specified configuration settings
    private final String inputFile;             //Input OSM XML file
    private final String outputFile;            //Output RDF file
    ...
    public OsmPbfParser(Configuration config, String inFile, String outFile, int sourceSRID, int targetSRID) {
        ...
        if (currentConfig.targetCRS != null) {
            try {
                ...
                CoordinateReferenceSystem sourceCRS = CRS.decode("EPSG:" + currentConfig.sourceCRS);
                CoordinateReferenceSystem targetCRS = CRS.decode("EPSG:" + currentConfig.targetCRS);
